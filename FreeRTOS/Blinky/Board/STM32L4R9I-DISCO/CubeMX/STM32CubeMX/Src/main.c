...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : ARD_D8_Pin ARD_D9_Pin */
  GPIO_InitStruct.Pin = ARD_D8_Pin|ARD_D9_Pin;
  ...
  /*Configure GPIO pins : ARD_D2_Pin ARD_D4_Pin */
  ...
  /*Configure GPIO pins : ARD_D5_Pin ARD_D7_Pin */
  GPIO_InitStruct.Pin = ARD_D5_Pin|ARD_D7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
